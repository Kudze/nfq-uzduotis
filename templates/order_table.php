...
<center>
        ...
        <form class="inline-form search-form <?php if($oMinPage <= $oMaxPage) echo ' search-form-wpg'; ?>" action="index.php#orders-container" method="get">
            <input type="hidden" id="page" name="page" value="orders">
            <input type="hidden" id="oPage" name="oPage" value="1">
            <input type="text" class="form-control" id="oSearch" name="oSearch" placeholder="Paieška" value="<?php $oSearchText ?>">
        ...
        <?php
            if($oMinPage <= $oMaxPage) Page::_loadTemplate("order_table_real");
